...
exports.parseCatalogV1 = parseCatalogV1;
var _catalogTypes = require("./catalogTypes");
const itemStringFields = ["name_kr", "name_en", "useType", "resist"];
const itemNumberFields = ["id", "maxUse", "level", "str", "sta", "dex", "wil", "hp", "quickslots", "buffslots", "smash", "movement", "charge", "lob", "serve", "max_str", "max_sta", "max_dex", "max_wil", "spin", "atss", "dfss", "socket", "gauge", "gauge_battle"];
const itemBooleanFields = ["hidden", "element_enchantable", "parcel_enabled"];
...
function validateItem(value, index) {
  ...
  if (item.character !== null) {
    enumValue(item.character, _catalogTypes.catalogCharacters, `${path}.character`);
  }
  enumValue(item.part, _catalogTypes.catalogParts, `${path}.part`);
  return item;
}
function parseCatalogV1(value) {
  ...
  const gachas = array(root.gachas, "gachas").map((value, index) => {
    ...
    for (const [dropIndex, value] of array(gacha.drops, `${path}.drops`).entries()) {
      ...
      enumValue(drop.character, _catalogTypes.catalogCharacters, `${dropPath}.character`);
      const shopProductIndex = integer(drop.shopProductIndex, `${dropPath}.shopProductIndex`);
  ...
  const stageSources = array(root.stageSources, "stageSources").map((value, index) => {
    const path = `stageSources[${index}]`;
    const source = record(value, path);
    const attached = integer(source.attachedProductIndex, `${path}.attachedProductIndex`);
    if (!productIds.has(attached)) {
      invalid(`${path} references unknown product ${attached}`);
    }
    for (const product of array(source.rewardProductIndexes, `${path}.rewardProductIndexes`)) {
...
},{"./catalogTypes":2}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.catalogParts = exports.catalogCharacters = void 0;
const catalogCharacters = exports.catalogCharacters = ["Niki", "LunLun", "Lucy", "Shua", "Dhanpir", "Pochi", "Al"];
const catalogParts = exports.catalogParts = ["Hat", "Hair", "Dye", "Upper", "Lower", "Shoes", "Socks", "Hand", "Backpack", "Face", "Racket", "Other"];
...
},{"./html":5}],4:[function(require,module,exports){
"use strict";
...
let bossArtCatalog = {};
function hydrateCatalog(input) {
  const catalog = (0, _catalog.parseCatalogV1)(input);
  ...
  for (const product of catalog.products) {
    ...
    const innerItems = product.itemIds.map(id => nextItems.get(id));
    const source = new ShopItemSource(product.productIndex, product.price, product.ap, innerItems);
  ...
  const products = new Map(catalog.products.map(product => [product.productIndex, product]));
  const nextGachas = new Map();
  for (const value of catalog.gachas) {
    const product = products.get(value.productIndex);
    const gacha = new Gacha(product.productIndex, product.gachaIndex, product.name, product.price, product.ap, product.enabled, product.purchasable);
    for (const drop of value.drops) {
      gacha.add(nextShopItems.get(drop.shopProductIndex), drop.probability, drop.character, drop.quantityMin, drop.quantityMax);
    }
  ...
  for (const value of catalog.stageSources) {
    ...
    const rewards = value.rewardProductIndexes.map(id => nextShopItems.get(id));
    attached.sources.push(new GuardianItemSource(value.map, rewards, value.xp, value.needBoss, value.bossTime));
  }
  exports.items = items = nextItems;
  exports.shop_items = shop_items = nextShopItems;
  exports.gachas = gachas = nextGachas;
...
async function downloadItems() {
  ...
  hydrateCatalog(JSON.parse(await download("assets/catalog.json")));
}
...
},{"./catalog":1,"./gachaAcquisition":4,"./html":5,"./priority":8,"./priorityStatHeaders":9,"./stageBosses":11}],7:[function(require,module,exports){
"use strict";
...
},{"./checkboxTree":3,"./html":5,"./itemLookup":6,"./priority":8,"./progressiveRender":10,"./storage":12}],8:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
